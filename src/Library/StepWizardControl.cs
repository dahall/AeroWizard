...
namespace AeroWizard
{
	...
	public class DrawStepListItemEventArgs : EventArgs
	{
		...
		/// <value>A rectangle that represents the bounds of the item to draw.</value>
		...
		/// <summary>Gets the <see cref="Font"/> used to draw the item.</summary>
		/// <value>The <see cref="Font"/> used to draw the item.</value>
		public Font Font { get; }

		/// <summary>Gets the <see cref="Graphics"/> used to draw the item.</summary>
		/// <value>The <see cref="Graphics"/> used to draw the item.</value>
		public Graphics Graphics { get; }

		/// <summary>Gets the <see cref="WizardPage"/> to which this item refers.</summary>
		/// <value>The <see cref="WizardPage"/> to which this item refers.</value>
	...
	public class StepWizardControl : WizardControl, IExtenderProvider
	{
		...
		/// </summary>
		/// <value><c>true</c> if the StepWizardControl step list is drawn by code that you provide; otherwise, <c>false</c>.</value>
		...
		/// <value>The width of the step list.</value>
		...
		public void SetStepText(WizardPage page, string value) => list.SetStepText(page, value);

		/// <summary>Sets the step text indent level.</summary>
		/// <param name="page">The page.</param>
		/// <param name="value">The indent level.</param>
		public void SetStepTextIndentLevel(WizardPage page, int value) => list.SetStepTextIndentLevel(page, value);
		...
		private void list_DrawItem(object sender, DrawStepListItemEventArgs e) => OnDrawStepListItem(e);

		private void list_MeasureItem(object sender, MeasureStepListItemEventArgs e) => OnMeasureStepListItem(e);

		private void Pages_Reset(object sender, System.Collections.Generic.EventedList<WizardPage>.ListChangedEventArgs<WizardPage> e)
		{
			pageContainer.Controls.Add(splitter);
			pageContainer.Controls.Add(list);
		}

		private void ResetStepListFont() => list.Font = Font;
