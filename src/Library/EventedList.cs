...
namespace System.Collections.Generic
{
	...
	public class EventedList<T> : IList<T>, IList
	{
		...
		/// <summary>Adds an item to the <see cref="EventedList{T}"/>.</summary>
		...
		/// <param name="item">The object to locate. The value can be <c>null</c> for reference types.</param>
		/// <param name="comparer">
		/// The <see cref="IComparer{T}"/> implementation to use when comparing elements, or <c>null</c> to use the default comparer <see cref="Comparer{T}.Default"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of <paramref name="item"/> in the sorted <see cref="EventedList{T}"/>, if <paramref name="item"/> is found;
		/// otherwise, a negative number that is the bitwise complement of the index of the next element that is larger than item or, if
		...
		/// <summary>Determines whether the <see cref="EventedList{T}"/> contains a specific value.</summary>
		...
		/// <summary>
		/// Copies the elements of the <see cref="EventedList{T}"/> to an <see cref="T:System.Array"/>, starting at a particular <see
		...
		/// <returns>
		/// <c>true</c> if the <see cref="EventedList{T}"/> contains one or more elements that match the conditions defined by the specified
		...
		/// <summary>Performs the specified action on each element of the <see cref="EventedList{T}"/>.</summary>
		...
		/// <summary>Removes the <see cref="EventedList{T}"/> item at the specified index.</summary>
		...
		/// <summary>Removes a range of elements from the <see cref="EventedList{T}"/>.</summary>
		...
		/// <summary>Reverses the order of the elements in the entire <see cref="EventedList{T}"/>.</summary>
		...
		/// <summary>Sorts the elements in the entire <see cref="EventedList{T}"/> using the default comparer.</summary>
		public void Sort() => Sort(0, Count, null);

		/// <summary>Sorts the elements in the entire <see cref="EventedList{T}"/> using the specified comparer.</summary>
		/// <param name="comparer">
		/// The <see cref="IComparer{T}"/> implementation to use when comparing elements, or <c>null</c> to use the default comparer <see cref="Comparer{T}.Default"/>.
		/// </param>
		public void Sort(IComparer<T> comparer) => Sort(0, Count, comparer);

		/// <summary>Sorts the elements in a range of elements in <see cref="EventedList{T}"/> using the specified comparer.</summary>
		...
		/// <summary>Copies the elements of the <see cref="EventedList{T}"/> to a new array.</summary>
		...
		/// <returns>
		/// <c>true</c> if every element in the <see cref="EventedList{T}"/> matches the conditions defined by the specified predicate;
